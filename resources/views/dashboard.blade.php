...
@section('content')
    <!-- Main dashboard area -->
    <main class="flex-1 p-2 min-h-screen">
        <h1 class="text-3xl font-semibold text-red-700 mb-8 inline-flex items-center space-x-3 bg-red-50 rounded-lg px-6 py-3 shadow-lg max-w-max">
            <span>Welcome,</span>
